    ...
    <div class="pcoded-content pb-4">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10"><i data-feather="plus"></i> เพิ่มสินค้าและราคา</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">ลูกค้า</li>
                            <li class="breadcrumb-item">ข้อมูลสินค้าและราคา</li>
                            <li class="breadcrumb-item">เพิ่มสินค้าและราคา</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 mb-3">
                <form id="create_customer_item_form" class="needs-validation" method="post" action="" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 mb-3">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <select id="customer_item_goods" name="customer_item_goods" class="form-control select2" data-placeholder="เลือกสินค้า...">
                                                        <option></option>
                                                    <?php 
                                                        foreach (getGoodsList() as $key_goods => $value_goods) {
                                                            if (count(getCustomerItemByCustomerGoods($id, $value_goods['id'])) != 0) {
                                                                echo '<option value="'.$value_goods['id'].'" disabled>'.$value_goods['goods_code'].' - '.$value_goods['goods_name'].' (มีในรายการแล้ว)</option>';
                                                            }
                                                            else {
                                                ...
                                                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    ...
                                                    <input type="text" id="customer_item_cuscode" name="customer_item_cuscode" class="form-control" maxlength="50" value="">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <input type="number" id="customer_item_max" name="customer_item_max" class="form-control" min="1" step="1" value="">
                                                ...
                                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <input type="number" id="customer_item_min" name="customer_item_min" class="form-control" min="1" step="1" value="">
                                                ...
                                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <input type="text" id="customer_item_unit_price" name="customer_item_unit_price" class="form-control" maxlength="20" value="">
                                                ...
                                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <input type="text" id="customer_item_total_price" name="customer_item_total_price" class="form-control" maxlength="20" readonly value="">
                        ...
                        <div class="col-xl-12 col-md-12">
                            <button type="submit" id="addCustomerItemGoods" name="addCustomerItemGoods" class="btn btn-success float-right ml-1"><i data-feather="download"></i> บันทึกข้อมูล</button>
...
<script type="text/javascript">
$(document).ready(function () {
    $("#create_customer_item_form").validate({
        ignore: ":hidden",
        validClass: "is-valid",
...
<?php 
if(isset($_POST['addCustomerItemGoods'])) {
    addCustomerItemGoods();
}
?>